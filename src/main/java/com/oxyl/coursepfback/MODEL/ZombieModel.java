...
public class ZombieModel {
    ...
    public ZombieModel(String nom, int point_de_vie, float attaque_par_seconde, int degat_attaque, float vitesse_de_deplacement, String chemin_image, int id_map) {
        this.nom = nom;

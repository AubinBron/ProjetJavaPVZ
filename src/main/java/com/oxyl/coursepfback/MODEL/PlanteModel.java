...
public class PlanteModel {
    ...
    public PlanteModel(String nom, int point_de_vie, float attaque_par_seconde, int degat_attaque, int cout, float soleil_par_seconde, String effet, String chemin_image) {
        this.nom = nom;
